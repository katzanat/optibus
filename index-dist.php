...
<html lang="en">
<head>
    <title>Kaltura - Play and Win!</title>
    <meta charset="utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="assets/css/kaltura-fonts.css" rel="stylesheet" type="text/css" media="none" onload="this.media='all';">
    <link rel="stylesheet" type="text/css" href="assets/css/app.css" media="none" onload="this.media='all';">
    <link rel="shortcut icon" href="http://www.kaltura.org/misc/favicon.ico" type="image/x-icon"/>
    <!-- Analytics -->
    <script>
	...
	<div class="fontrender" style="height: 0; overflow: hidden">
		...
		<div class="app-parent" style="display: none">
			<div class="app-inner-parent">
				<div class="brands">
					<div class="left-logo">
						<img src="assets/images/kaltura_logo.png" alt="" />
					</div><!-- .left-logo -->
					</div><!-- .brands -->
				<div id="welcome-screen" class="screen">
					<div class="container">
						<div class="head-text">
							<h1>Try Your Luck<br><span class="h1-sub-header">Play to Win!</span></h1>

						</div><!-- .head-text -->
						<div class="page-content start-btn-wrapper">
							<button data-target="form-screen" class="cta-btn relocate-btn load_sound">Start</button>
						</div><!-- .page-content -->
					</div><!-- .container -->
				</div><!-- #welcome-screen -->
									...
									<div class="form-right-side">
										...
										<div class="field-container group">
											<label for="inhouse_apps">
												*  Is the company you're working for operating an OTT/IP-TV service?
											</label>
					...
					<div class="container">
						<div class="page-content">
							...
							<div class="spin-to-win-container">
								<button id="slot_play" class="cta-btn slot_play form-btn">Spin</button>
				...
				<div id="lose-screen" class="screen" style="display: none;">
					<div class="container">
						<div class="page-content">
							<div class="lost-container group">
								<div class="lost-text">
									<h1 class="">AWWWW…</h1>
					...
					<div class="container">
						<div class="page-content">
							<div class="already-container">
							    <p class="user-full-name"></p>
								<h1>SORRY, YOU ALREADY TRIED<br>YOUR LUCK.</h1>
